    ...
    <div className='Home'>
      <Container maxWidth='md'>
        ...
        <Typography variant='body1' gutterBottom>
          <i>
            This website contains searchable metadata that references user contributed samples, programs and 'sounds' found at the Nord User Form
            (norduserforum.com).
          </i>
        </Typography>
        <Typography variant='body1' gutterBottom>
          ...
          on their official website, Nord users have been creating and sharing their own samples and programs on the Nord User Forum for many years.
        </Typography>
        <Typography variant='body1' gutterBottom>
        ...
        <Typography variant='body1' gutterBottom>
          A while back, one of the forum members (“spookycookie”) took it upon himself to create a better tool for organizing samples, sounds and programs for
          ...
          likely still reside at the Nord User Forum (however some newer sounds might have been added directly on this site). This website should help you find
        ...
        <Typography variant='body1' gutterBottom>
          ...
          synth), as well as desired effects, filtering and more. Many people also use the term 'sound' to describe the same concept.
        </Typography>
        <Typography variant='body1' gutterBottom>
        ...
        <Typography variant='body1' gutterBottom>
          A 'program' or 'sound' often requires one or more samples to be loaded into the keyboard to work properly. If you load a sample that doesn’t have an
          associated program or sample file, you’ll want to create your own using your keyboard controls. See Nord’s excellent documentation if you’re not
